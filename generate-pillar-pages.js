...
const pages = {
  'home-tuition.html': {
    ...
    image: 'assets/images/home-tuition-study-guide.webp',
  ...
  'online-tuition.html': {
    ...
    image: 'assets/images/online-tuition-learning-guide.webp',
  ...
  'classes.html': {
    ...
    image: 'assets/images/students-learning-with-mentor.webp',
  ...
  'exam-preparation.html': {
    ...
    image: 'assets/images/class-10-board-exam-preparation-guide.webp',
...
<body>
  ...
  <main>
    ...
    <section class="section-padding"><div class="container"><div class="row g-5 align-items-center"><div class="col-lg-6"><img class="rounded-media" src="${page.image}" alt="${page.imageAlt}" width="1000" height="750" loading="lazy" decoding="async"></div><div class="col-lg-6"><span class="section-kicker">Pillar Guide</span><h2>${page.introTitle}</h2><p>${page.intro}</p><a class="btn btn-outline-brand" href="/student-registration">Share Learning Requirements</a></div></div></div></section>
